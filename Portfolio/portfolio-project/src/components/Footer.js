...
const Footer = () => {
  return (
    ...
    <div className='flex flex-col items-center gap-6 text-base font-medium mb-12'>
        <a href="mailto:contact.mikeariwaodo@gmail.com" target="_top">contact.mikeariwaodo@gmail.com</a>
    ...
    <div className='gap-2 flex flex-col justify-between sm:flex-row items-center text-xs font-medium'>
        ...
        <span className="w-4/12 sm:w-[12%] flex flex-col items-center uppercase border border-solid border-black dark:border-white bg-stone-300 dark:bg-black py-1 px-2 rounded-full shadow-xl">
        ...
        <span className=''>Designed by <a href='https://twitter.com' target="_blank" className='text-emerald-700 dark:text-sky-400'>Ebuka Elubah</a></span>
    </div>
    </section>
  )
}
