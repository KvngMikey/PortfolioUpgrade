...
const Works = (props) => {
  return (
    <li className="w-full sm:w-[46%] pl-4 flex flex-col border border-solid border-black dark:border-white bg-stone-300 dark:bg-black py-4 px-2 shadow-xl mx-4 mb-4">
