...
const About = () => {
  return (
    <section id="about" className="flex flex-col-reverse justify-center sm:flex-col p-4 items-center gap-8 mb-12 scroll-mt-40 widescreen:section-min-height tallscreen:section-min-height">
       ...
       <span className="text-[172px] custom-style hidden leading-[13rem] sm:block">Front ——— End</span>
       <span className="text-[172px] custom-style hidden leading-[13rem] sm:block">Developer</span>
