  ...
  return (
    <section id="contact" className="p-6 scroll-mt-40">
      ...
      <div className='flex flex-col items-center gap-6 text-base font-medium mb-8'>
        <motion.a whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} href="mailto:contact.mikeariwaodo@gmail.com" target="_top" className='hover:text-orange-700'>contact.mikeariwaodo@gmail.com</motion.a>
      ...
      <div className='flex flex-col justify-between sm:flex-row items-center text-xs font-medium'>
        ...
        <div className='flex flex-row gap-4 mx-4 my-2'>
          <motion.span whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="hover:bg-orange-700 hover:text-black flex flex-col items-center uppercase border border-solid border-black dark:border-white bg-stone-300 dark:bg-black dark:hover:bg-orange-700 py-1 px-2 rounded-full shadow-xl">
