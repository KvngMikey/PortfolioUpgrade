...
const Skills = (props) => {
  return (
            ...
            <li class="w-52 flex flex-col items-center border border-solid border-black dark:border-white bg-stone-300 dark:bg-black py-6 px-2 rounded-full shadow-xl mx-6 my-4">
